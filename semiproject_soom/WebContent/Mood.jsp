				...
				<div class="station_wrap">
					<ul>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="Moodmore.jsp" class="link01">
										<p class="mood_name">#기분좋은날</p>
									</a>
								</div>
							</div>
						</li>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="Moodmore.jsp" class="link02"> 
									<p class="mood_name">#기분나쁜날</p></a>
								</div>
							</div>
						</li>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="Moodmore.jsp" class="link03"> <p class="mood_name">#힘든날</p></a>
								</div>
							</div>
						</li>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="#" class="link04"><p class="mood_name">#졸린날</p> </a>
								</div>
							</div>
						</li>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="Moodmore.jsp" class="link05"><p class="mood_name">#드라이브 갈 때</p> </a>
								</div>
							</div>
						</li>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="Moodmore.jsp" class="link06"><p class="mood_name">#공연이 그리울때</p> </a>
								</div>
							</div>
						</li>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="#" class="link07"> <p class="mood_name">#헤어졌을때</p></a>
								</div>
						...
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="Moodmore.jsp" class="link08"> <p class="mood_name">#숙면을위해</p></a>
								</div>
							</div>
						</li>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="Moodmore.jsp" class="link09"> <p class="mood_name">#우울할때</p></a>
								</div>
							</div>
						</li>
						<li class="list_item">
							<div>
								<div class="thumb_area">
									<a href="Moodmore.jsp" class="link10"> <p class="mood_name">#비오는 날</p></a>
								</div>
							</div>
						</li>
