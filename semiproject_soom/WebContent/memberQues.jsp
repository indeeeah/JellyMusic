			...
			<div id="board">
				<div class="board_wrap">
					...
					<div id="page">
						...
						%>
						<a
							href="<%=ctxPath%>/postListServlet?pageNum=<%=currentPage - pageBlock%>">[이전]</a>
						<%
							} else {
						%>
						[이전]
						...
						<%
							...
							if (currentPage != i) {
						%>
						<a href="<%=ctxPath%>/postListServlet?pageNum=<%=i%>">[<%=i%>]
						</a>
						<%
							} else {
						%>
						...
						%>
						<a
							href="<%=ctxPath%>/postListServlet?pageNum=<%=startPage + pageBlock%>">[다음]</a>
						<%
							} else {
						%>
						[다음]
