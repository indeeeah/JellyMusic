		...
		<div id="wrapper">
			<form name="registerFrm" id="reg_con">
				<div>
					...
					<span class="box int_id"> <input type="text" id="mem_id"
						name="mem_id" class="int" maxlength="20">
				</div>
				<div>
					<h3 class="join_title">
					...
					<span class="box int_pass"> <input type="password"
						id="mem_pwd" name="mem_pwd" class="int" maxlength="20">
				</div>
				<div>
					<h3 class="join_title">
						<label for="mem_name">이름</label>
					</h3>
					<span class="box int_name"> <input type="text" id="mem_name"
						name="mem_name" class="int" maxlength="20">
				</div>
				<div>
					<h3 class="join_title">
					...
					<div id="bir_wrap">
						<div id="bir_birth">
							<span class="box"> <input type="text" id="mem_birth"
								name="mem_birth" class="int" maxlength="4" placeholder="년(4자)">
							</span>
						</div>
						<div id="bir_mm">
				...
				<div>
					...
					<span class="box gender_code"> <select id="mem_gender"
						name="mem_gender" class="sel">
				...
				<div>
					<h3 class="join_title">
						<label for="mem_email">본인확인 이메일<span class="optional">(선택)</span></label>
					</h3>
					<span class="box int_email"> <input type="text"
						id="mem_email" name="mem_email" class="int" maxlength="100"
						placeholder="선택입력">
				</div>
				<div>
					<h3 class="join_title">
					...
					<span class="box int_phone"> <input type="tel"
						id="mem_phone" name="mem_phone" class="int" maxlength="16"
						placeholder="전화번호 입력">
				</div>
				<div class="btn_area">
