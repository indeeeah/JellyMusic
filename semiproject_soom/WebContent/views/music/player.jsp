...
<link href="${pageContext.request.contextPath}/css/player.css" rel="stylesheet" type="text/css">
	...
	pageEncoding="UTF-8"%>
            <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
                ...
                <head>
                    ...
                    <style>
                        #player_left>#hb_con {
                            background-image: url('${pageContext.request.contextPath}/image/001-lyrics.svg');
                        ...
                        .vol {
                            background-image: url('${pageContext.request.contextPath}/image/002-spaceship.svg');
                ...
                <body>
                    ...
                    <div id="player_left">
                        <div id="hb_con"></div>
                        <input type="checkbox" id="lyrics" name="lyrics"><label for="lyrics">가사</label>
                        <div id="lyrics_con">
                            <p id="ly">
                    ...
                    <div id="player_right">
						...
						<div class="heart" id="whiteheart"></div>
                                    ...
                                    <input type="radio" name="heart_check" id="togreenheart_chk" value="heartdown" class="heartchkbox" style="display: none;">
						...
						<div class="heart" id="greenheart" style="display: none;"></div>
                                    ...
                                    <c:if test="${not empty scm }">
                                        <c:forEach items="${scm }" var="v" varStatus="s" end="0">
                                            <input type="hidden" name="mu_no" id="munoforheart" value=${v.mu_no }>
                                            <input type="hidden" name="mu_no" id="munoforheartd" value=${v.mu_no }>
                                        </c:forEach>
                                    </c:if>
                                </c:if>
                                <c:if test="${heart eq 1}">
                                    <input type="radio" name="heart_check" id="towhiteheart_chk" value="heartup" class="heartchkbox" style="display: none;">
                                    <label for="togreenheart_chk">
						<div class="heart" id="whiteheart" style="display: none;"></div>
					</label>
                                    <input type="radio" name="heart_check" id="togreenheart_chk" value="heartdown" class="heartchkbox" checked style="display: none;">
                                    <label for="towhiteheart_chk">
                        ...
                        <c:if test="${not empty scm }">
                            <c:forEach items="${scm }" var="v" varStatus="s" end="0">
                                <div id="togo">
                                    <div id="tomusic"><a class="togogo" href="">music</a></div>
                                    <div id="toartist"><a class="togogo" href="">artist</a></div>
                                    <div id="toalbum"><a class="togogo" href="">album</a></div>
                                </div>
                            </c:forEach>
                        </c:if>
