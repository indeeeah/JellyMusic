...
<link href="${pageContext.request.contextPath}/css/song_main_login.css"
	rel="stylesheet" type="text/css">
						...
						<c:forEach items="${t1p }" var="v" varStatus="s">
							<div class="top100_each_l">
								<a
									...
									class="tri_con"> <img
									src="${pageContext.request.contextPath}/allfile/${v.f_name }"
									class="t100_l_album"></img>
									<div class="top100_tri"></div>
								</a> <input type="hidden" class="top100go" name="mu_no"
									value=${v.mu_no }>
								<div>
									<div class="t100_title">
										<a
											href="${pageContext.request.contextPath}/musicMoreServlet?mu_no=${v.mu_no}">${v.mu_name }</a>
									</div>
									<div class="t100_name">
										<a
											href="${pageContext.request.contextPath}/artistMoreServlet?art_no=1">${v.art_name }</a>
									</div>
								</div>
							</div>
						</c:forEach>
