...
<%
	...
	String que_file = request.getParameter("que_file");
...
<form 
	...
	<table border="1">
		...
		<tr>
		<td>제목</td>
		<td id="subject"><input type="text" name = "que_name" id="inputSub" value="<%= que_name%>" required></td>
		</tr>
		<tr>
		<td>내용</td>
		<td id="content"><input type="text" name = "que_content" id="inputCont" value="<%= que_content%>" required></td>
		</tr>
		<tr>
		<td>파일선택</td>
		<td id="file"><input type="file" name = "que_file" value="<%= que_file%>"></td>
		</tr>
		<tr>
		<tr>
		<td>비밀글여부</td>
		<td>나만보기<input type="radio" name = "que_secret" value="O" id="que_secret" checked>
			전체공개<input type="radio" name = "que_secret" value="X" id="que_secret" ></td>
		</tr>
		<tr>
		<td colspan = "2">
